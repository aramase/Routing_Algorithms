...
public class IPExtraCredit 
{
    ...
    static int thisPort=8000; //Changes for every node....listening port
    static int thisNode=2; //Changes for every node
    static int recNode;
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, InterruptedException 
    {
       ...
       ipAddress[1]=InetAddress.getByName("127.0.0.1"); //thisNode
       ipAddress[2]=InetAddress.getByName("127.0.0.1");
       ipAddress[3]=InetAddress.getByName("127.0.0.1");
       ipAddress[4]=InetAddress.getByName("127.0.0.1");
       
       try
       {
           sock=new DatagramSocket(thisPort);
           DatagramPacket incoming=new DatagramPacket(buffer,buffer.length);
           System.out.println("Host "+thisNode+" Up and Running. Waiting for Distance Vector from other Hosts");
